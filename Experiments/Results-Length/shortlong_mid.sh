...
MDL_LOC_PLS="model-shortlong/"
python3 train_model.py --train "data/BABI_shortlong/cleaned/task1-trn.txt" --dev "data/BABI_shortlong/cleaned/task1-dev.txt" --output_dir $MDL_LOC_PLS --print_every 200 --max_len 75 --embedding_size $EMB_SIZE --hidden_size $H_SIZE --epoch $NUM_EP --teacher_forcing .5 --attention

echo "Train-scores"
python3 evaluate.py --checkpoint_path $MDL_LOC_PLS$(ls -t $MDL_LOC_PLS | head -1) --test_data "data/BABI_shortlong/cleaned/task1-trn.txt" --max_len 75
