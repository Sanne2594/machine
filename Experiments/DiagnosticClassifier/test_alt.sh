...
M_DATA="DataGeneration/disfluency-masks/correction_tst_alteration-masks.txt"
python3 ../../test-DC.py --checkpoint_path $MDL_DC --mask_data $M_DATA --max_len 76 --batch_size 32 --weight_vec $W_VEC
...
M_DATA="DataGeneration/disfluency-masks/restart_tst_alteration-masks.txt"
