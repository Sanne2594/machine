...
python3 test-DC.py --checkpoint_path $MDL_DC$(ls -t $MDL_LOC | head -1) --mask_data $M_DATA --max_len 75 --batch_size 32 --weight_vec $W_VEC --stats

echo "Testing for Restart"
M_DATA="data/disfluency-masks/restart_tst_alteration-masks.txt"
python3 test-DC.py --checkpoint_path $MDL_$(ls -t $MDL_LOC | head -1) --mask_data $M_DATA --max_len 75 --batch_size 1 --weight_vec $W_VEC --stats
