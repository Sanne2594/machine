...
### ### ### General Data
path = "/home/sanne/machine/data/BABIrestarthesi"
...
dialog_path = "/home/sanne/machine/data/BABIrestarthesi/clean/"
...
# ### Testing files
# fpath = os.path.join(path,test_new_entities)
# cpath = os.path.join(dialog_path,oov_clean)
# readBabiDialog(fpath,cpath)
#
# ### development files
